...
from entre_mundos_app.common import form_gasto, default_page_config, form_pagamento, balanco_financeiro, busca_tabela, form_editar_pagamento
...
def main():
    ...
    pagamento_col1, pagamento_col2 = controle_container.columns(2, vertical_alignment="center")
